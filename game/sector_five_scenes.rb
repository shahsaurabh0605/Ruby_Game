...
class SectorFive < Gosu::Window
  ...
  @bullets.dup.each do |bullet|
   ...
   def draw_end
 	...
 	draw_line(0,140,Gosu::Color::YELLOW,WIDTH,140,Gosu::Color::WHITE)
 	   @message_font.draw(@message,40,40,1,1,1,Gosu::Color::BLUE)
 	   @message_font.draw(@message2,40,75,1,1,1,Gosu::Color::BLUE)
  	draw_line(0,500,Gosu::Color::YELLOW,WIDTH,500,Gosu::Color::WHITE)
 	   @message_font.draw(@bottom_message,180,540,1,1,1,Gosu::Color::GREEN) 	
   end
